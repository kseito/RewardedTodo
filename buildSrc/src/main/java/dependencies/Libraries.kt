...
object Libraries {
    ...
    object AndroidX {
        ...
        object Compose {
            ...
            const val foundation = "androidx.compose.foundation:foundation:1.7.3"
            const val material = "androidx.compose.material:material:1.7.3"
            const val ui = "androidx.compose.ui:ui:1.7.3"
            const val uiTooling = "androidx.compose.ui:ui-tooling:1.7.3"
            const val liveData = "androidx.compose.runtime:runtime-livedata:1.7.4"
