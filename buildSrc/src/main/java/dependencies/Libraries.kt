...
object Libraries {
    ...
    object AndroidX {
        ...
        object Compose {
            ...
            const val foundation = "androidx.compose.foundation:foundation:1.7.1"
            const val material = "androidx.compose.material:material:1.7.1"
            const val ui = "androidx.compose.ui:ui:1.7.1"
            const val uiTooling = "androidx.compose.ui:ui-tooling:1.7.2"
            const val liveData = "androidx.compose.runtime:runtime-livedata:1.7.2"
    ...
    object Test {
        ...
        const val mockito = "org.mockito:mockito-core:5.13.0"
