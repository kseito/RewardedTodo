...
- [`docs/ci-cd.md`](docs/ci-cd.md) - CI/CD workflow overview
- [`docs/adr/`](docs/adr) - Architecture Decision Records (written in the [MADR](https://adr.github.io/madr/) Minimal template)
